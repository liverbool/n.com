  ...
  @include('Partials.Jumbotron')
    ...
    <div class="home container push-footer-wrapper">
	  ...
	  <div class="col-sm-8 home-news">
	    <h5>
	    	<span><i class="fa fa-bullhorn"></i> {{ trans('main.latest news') }}</span>
		    ...
		    <div class="media">
			  ...
			  <div class="media-body">
			  	...
			  	@if ($options->scrapeNewsFully())
					<h6 class="media-heading"><a href="{{{ Helpers::url($n->title, $n->id, 'news') }}}">{{{ $n['title'] }}}</a> </h6>
			   @else
			       <h6 class="media-heading"><a href="{{{ $n['full_url'] ? $n['full_url'] : Helpers::url($n->title, $n->id, 'news') }}}">{{{ $n['title'] }}}</a> </h6>
		       @endif
	  ...
	  <div class="col-sm-4">
	    <h5><span><i class="fa fa-fire"></i>{{ trans('main.in theaters') }}</span>
