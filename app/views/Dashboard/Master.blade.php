<div class="container">
	<div class="row stats-container">
 		<div class="box col-sm-2">
 			<span id="number">{{ $userCount }}</span><br><span id="text">Users in database</span>
 		</div>
 		<div class="box col-sm-2">
 			<span id="number">{{ $movieCount }}</span><br><span id="text">Movies in database</span>
 		</div>
 		<div class="box col-sm-2">
 			<span id="number">{{ $seriesCount }}</span><br><span id="text">Series in database</span>
 		</div>
 		<div class="box col-sm-2">
 			<span id="number">{{ $actorCount }}</span><br><span id="text">Actors in database</span>
 		</div>
 		<div class="box col-sm-2">
 			<span id="number">{{ $newsLastUpdated }}</span><br><span id="text">News updated</span>
 		</div>
 	</div><br>
 	...
 	<div class="col-sm-4">
 		...
 		<h4><i class="fa fa-wrench"></i> Scrape IMDb Advanced Search</h4>
 	...
 	<div class="scraper-container col-sm-4">
 		<h4><i class="fa fa-wrench"></i> Scrape TMDB Advanced Search</h4>
 	...
 	<div class="col-sm-4">
 		...
 		<div class="scraper-container">
			<h4>Fully Scrape Movies & Series</h4>
	 	...
	 	<div class="scraper-container">
			<h4>Update News, Trailers and Movies in Theaters</h4>
