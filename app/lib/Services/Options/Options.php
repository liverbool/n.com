...
class Options
{
	...
	{
		return $this->options['data_provider'] ? $this->options['data_provider'] : 'imdb';
	}
	...
	{
		return $this->options['search_provider'] ? $this->options['search_provider'] : 'imdb';
	}
	...
	/**
	 * Returns whether or not to automaticlly update featured trailers.
	 * 
	 * @return boolean
	 */
	public function autoUpdateFeatured()
	{
		if ( array_key_exists('auto_upd_fet', $this->options) )
		{
			return (int) $this->options['auto_upd_fet'];
		}
